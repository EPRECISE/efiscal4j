...
public class CTeValidationByXSD {
    
    private Schema schema;
    
    @Before
    public void load() throws SAXException {
	final URL xsd = this.getClass().getResource("/eprecise/efiscal4j/cte/cte_v2.00.xsd");
	final SchemaFactory factory = SchemaFactory.newInstance(XMLConstants.W3C_XML_SCHEMA_NS_URI);
	this.schema = factory.newSchema(xsd);
    }
    
    @Test
    public void testXMLOverXSD() throws JAXBException, SAXException, IOException {
	final CTeInfo cTeInfo = new CTeInfo.Builder().withIdentification(
		new Identification.Builder().withUF(UF.PR)
					    ...
					    .build())
						     .withEmitter(
							     new Emitter.Builder().withCNPJ("69.305.329/0001-67")
										  .withIE("ISENTO")
										  ...
										  .build())
						     .withSender(
							     new Sender.Builder().asLegalEntity()
										 ...
										 .withLocationCollection(
											 new Location.Builder().asLegalEntity()
										 ...
										 .build())
						     .withShipper(
							     new Shipper.Builder().asNaturalPerson()
										  .withCPF("08775530929")
										  .ok()
										  .withName("teste validacao")
										  .withFone("4299561913")
										  ...
										  .build())
						     .withReceiver(
							     new Receiver.Builder().asNaturalPerson()
										   .withCPF("08775530929")
										   .ok()
										   .withName("teste validacao")
										   .withFone("4299561913")
										   ...
										   .withAddress(
											   new Address.Builder().withStreet("RUA")
														...
														.build())
										   .build())
						     .withValuesServiceDelivery(
							     new ValuesServiceDelivery.Builder().withDelivertService("13")
												.withValueReceivable("13")
												.withInstallmentValueComponent(
													new InstallmentValueComponent.Builder().withName(
														"Teste")
																	       .withValue("10")
																	       .builder())
												.build())
	...
	marshaller.marshal(cTeInfo, out);
	final Validator validator = this.schema.newValidator();
	final String string = "<CTe>\n" + out.toString().replace("cTeInfo", "infCte") + "\n</CTe>";
