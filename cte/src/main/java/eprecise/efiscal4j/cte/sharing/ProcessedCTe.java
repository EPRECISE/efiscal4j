...
public class ProcessedCTe implements Serializable {
    ...
    private final @XmlElement(name = "protCTe") TypeStatusProtocol typeStatusProtocol;
	...
	private TypeStatusProtocol typeStatusProtocol;
	...
	public Builder withTypeStatusProtocol(TypeStatusProtocol typeStatusProtocol) {
    ...
    public TypeStatusProtocol getTypeStatusProtocol() {
