...
public class StatusProtocolData implements Serializable {
	...
	public StatusProtocolData build() {
	    return new StatusProtocolData(this);
	}
    }
    
    public StatusProtocolData() {
    ...
    public StatusProtocolData(Builder builder) {
