...
package eprecise.efiscal4j.nfse.tc.govbr.v100.compNfse;
...
import eprecise.efiscal4j.nfse.tc.govbr.v100.GovbrNFSe;
...
public class GovbrCompNFSe implements CompNFSe {
    ...
    private final @XmlElement(name = "Nfse") GovbrNFSe nfse;
