...
public enum CuritibaSpecialTaxationRegime implements NFSeSpecialTaxationRegime {
    ...
    public static CuritibaSpecialTaxationRegime findByValue(final Integer value) {
        for (final CuritibaSpecialTaxationRegime entity : CuritibaSpecialTaxationRegime.values()) {
