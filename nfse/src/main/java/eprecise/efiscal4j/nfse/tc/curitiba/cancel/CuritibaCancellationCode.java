...
public enum CuritibaCancellationCode implements NFSeCancellationCode {
    ...
    private CuritibaCancellationCode(final String value, final String description) {
        this.value = value;
    ...
    public static CuritibaCancellationCode findByCode(final String code) {
        for (final CuritibaCancellationCode entity : CuritibaCancellationCode.values()) {
