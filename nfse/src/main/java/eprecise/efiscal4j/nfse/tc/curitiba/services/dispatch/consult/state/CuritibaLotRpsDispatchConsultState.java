...
public class CuritibaLotRpsDispatchConsultState implements TransmissibleBodyImpl, NFSeRequest {
    ...
    public static class Builder {
        ...
        public CuritibaLotRpsDispatchConsultState build() {
            final CuritibaLotRpsDispatchConsultState entity = new CuritibaLotRpsDispatchConsultState(this);
            ValidationBuilder.from(entity).validate().throwIfViolate();
            return entity;
        }
    }

    public CuritibaLotRpsDispatchConsultState() {
        serviceProviderIdentifier = null;
        protocol = null;
    }

    public CuritibaLotRpsDispatchConsultState(final Builder builder) {
