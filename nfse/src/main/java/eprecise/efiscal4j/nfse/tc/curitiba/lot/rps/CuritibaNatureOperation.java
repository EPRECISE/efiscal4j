...
public enum CuritibaNatureOperation {
    ...
    private CuritibaNatureOperation(final Integer value, final String description) {
        this.value = value;
    ...
    public static CuritibaNatureOperation findByCode(final Integer natureOperation) {
        for (final CuritibaNatureOperation entity : CuritibaNatureOperation.values()) {
