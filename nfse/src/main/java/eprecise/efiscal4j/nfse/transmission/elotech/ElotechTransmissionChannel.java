 ...
 *
 */
public class ElotechTransmissionChannel implements TransmissionChannel<SOAPEnvelope, LotRpsDispatchSyncResponse> {
    ...
    @Override
    public TypedTransmissionResult<SOAPEnvelope, LotRpsDispatchSyncResponse> transmitAuthorization(final LotRpsDispatchSync lotRpsDispatch) throws Exception {
        ...
        lotRpsDispatch.setXmlns(NFSeTransmissor.getXmlns(cityCode));
        ...
        ((LotRpsDispatchSync) soapEnvelope.getSoapBody().getTransmissibleBody()).setXmlns(NFSeTransmissor.getXmlns(cityCode));
        ...
        String responseXml = transmissor.transmit(requestXml, NFSeTransmissor.getUrl(cityCode));
        ...
        return new TypedTransmissionResult<>(SOAPEnvelope.class, LotRpsDispatchSyncResponse.class, requestXml, responseXml);
