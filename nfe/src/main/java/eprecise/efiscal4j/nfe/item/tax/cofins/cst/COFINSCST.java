...
package eprecise.efiscal4j.nfe.item.tax.cofins.cst;
 ...
 *
 */
public enum COFINSCST implements Serializable {
    ...
    private final PropertiesLoader cofinsCstMap = new PropertiesLoader.Builder().resourceLoader(COFINSCST.class).from("/eprecise/efiscal4j/nfe/cst/cofinsCst.properties").create();

    private final String value;

    private COFINSCST(String value) {
        this.value = value;
    }
