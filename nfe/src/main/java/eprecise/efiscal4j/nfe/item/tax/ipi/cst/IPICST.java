...
package eprecise.efiscal4j.nfe.item.tax.ipi.cst;
...
public enum IPICST implements Serializable {
    ...
    private final PropertiesLoader ipiCstMap = new PropertiesLoader.Builder().resourceLoader(IPICST.class).from("/eprecise/efiscal4j/nfe/cst/ipiCst.properties").create();
