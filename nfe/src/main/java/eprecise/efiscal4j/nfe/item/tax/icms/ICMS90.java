...
@Builder
@Getter
public class ICMS90 implements ICMS, IcmsWithBcValueHolder, IcmsDesonerationHolder, IcmsStWithBcValueHolder, IcmsWithFcpValueHolder, IcmsWithFcpStValueHolder {

    private final ICMSCST cst = ICMSCST.CST_90;
