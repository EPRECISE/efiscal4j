...
package eprecise.efiscal4j.nfe.item.tax.pis.cst;
...
public enum PISCST implements Serializable {
    ...
    private final PropertiesLoader pisCstMap = new PropertiesLoader.Builder().resourceLoader(PISCST.class).from("/eprecise/efiscal4j/nfe/cst/pisCst.properties").create();
