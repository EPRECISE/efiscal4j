...
import eprecise.efiscal4j.nfe.v400.types.NFeDeliveryDFeEventSequence;
...
public class NFeEventSummary implements Serializable {
	...
	public static final String XSD = "/eprecise/efiscal4j/nfe/v400/xsd/deliveryDFe/resEvento_v1.01.xsd";
	...
	private @XmlElement(name = "CNPJ") @NotNull @CNPJ(formatted = false) @Size(max = 14) @NFeCNPJ final String cnpj; // Campo
																														// é
																														// uma
																														// xs:choice
																														// com
	...
	public static class Builder {
		...
		/**
		 * Data e Hora do Evento, formato UTC (AAAA-MM-DDThh:mm:ssTZD, onde TZD = +hh:mm
		 * ou -hh:mm)
		 */
		...
		/**
		 * Número do Protocolo do evento. 1 posição (1 – Secretaria de Fazenda Estadual
		 * 2 – Receita Federal); 2 - códiga da UF - 2 posições ano; 10 seqüencial no ano
		 */
