...
public class DefaultJasperDanfeCatalog implements JasperDanfeCatalog {
    ...
    private final Map<DANFEPrintFormat, String> danfeMap = new HashMap<DANFEPrintFormat, String>() {
        ...
        {
            this.put(DANFEPrintFormat.SEM_DANFE, "eprecise/efiscal4j/nfe/v400/danfe/retrato/danfe_retrato.jasper");
            this.put(DANFEPrintFormat.DANFE_SIMPLIFICADO, "eprecise/efiscal4j/nfe/v400/danfe/paisagem/danfe_paisagem.jasper");
            this.put(DANFEPrintFormat.DANFE_RETRATO, "eprecise/efiscal4j/nfe/v400/danfe/retrato/danfe_retrato.jasper");
            this.put(DANFEPrintFormat.DANFE_PAISAGEM, "eprecise/efiscal4j/nfe/v400/danfe/paisagem/danfe_paisagem.jasper");
            this.put(DANFEPrintFormat.DANFE_NFCE, "eprecise/efiscal4j/nfe/v400/nfce/danfe/danfe_nfce.jasper");
            this.put(DANFEPrintFormat.DANFE_NFCE_MENSAGEM_ELETRONICA, "eprecise/efiscal4j/nfe/v400/nfce/danfe/danfe_nfce.jasper");
        }
    };
