...
public enum ICMSCST implements Serializable {
    ...
    private final PropertiesLoader icmsCstMap = new PropertiesLoader.Builder().resourceLoader(ICMSCST.class).from("/eprecise/efiscal4j/nfe/v400/icmsCst.properties").create();
