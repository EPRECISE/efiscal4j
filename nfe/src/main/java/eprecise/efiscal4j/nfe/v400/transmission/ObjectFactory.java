...
public class ObjectFactory {
	...
	public static final String MANIF_DEST_EVENTO_RESULT = "nfeRecepcaoEventoNFResult";
	...
	// public JAXBElement<NFeDispatchResponse> createNFeDispatchResponse(final
	// NFeDispatchResponse receivableBody) {
	// return new JAXBElement<>(new QName(ObjectFactory.RET_ENVI_NFE),
	// NFeDispatchResponse.class, receivableBody);
	// }
	...
	// public JAXBElement<BatchReceiptSearchResponse>
	// createBatchReceiptSearchResponse(final BatchReceiptSearchResponse
	// receivableBody) {
	// return new JAXBElement<>(new QName(ObjectFactory.RET_CONS_RECI_NFE),
	// BatchReceiptSearchResponse.class, receivableBody);
	// }
	...
	// public JAXBElement<NFeStatusSearchResponse>
	// createNFeStatusSearchResponse(final NFeStatusSearchResponse transmissible) {
	// return new JAXBElement<>(new QName(ObjectFactory.RET_CONS_SIT_NFE),
	// NFeStatusSearchResponse.class, transmissible);
	// }
	...
	// public JAXBElement<ServiceStatusSearchResponse>
	// createServiceStatusSearchResponse(final ServiceStatusSearchResponse
	// receivableBody) {
	// return new JAXBElement<>(new QName(ObjectFactory.RET_CONS_STAT_SERV),
	// ServiceStatusSearchResponse.class, receivableBody);
	// }
	...
	// public JAXBElement<EventDispatchResponse> createEventDispatchResponse(final
	// EventDispatchResponse receivableBody) {
	// return new JAXBElement<>(new QName(ObjectFactory.RET_ENV_EVENTO),
	// EventDispatchResponse.class, receivableBody);
	// }

	@XmlElementDecl(name = ObjectFactory.NFE_STAT_SERV_RESULT)
	public JAXBElement<ServiceStatusSearchResponseMethod> createServiceStatusSearchResponseMethod(
			final ServiceStatusSearchResponseMethod receivable) {
		return new JAXBElement<>(new QName(ObjectFactory.NFE_STAT_SERV_RESULT), ServiceStatusSearchResponseMethod.class,
				receivable);
	}

	// @XmlElementDecl(name = ObjectFactory.NFE_CONS_NFE_RESULT)
	// public JAXBElement<NFeStatusSearchResponseMethod>
	// createNFeStatusSearchResponseMethod(final NFeStatusSearchResponseMethod
	// receivable) {
	// return new JAXBElement<>(new QName(ObjectFactory.NFE_CONS_NFE_RESULT),
	// NFeStatusSearchResponseMethod.class, receivable);
	// }

	@XmlElementDecl(name = ObjectFactory.NFE_AUT_LOTE_RESULT)
	public JAXBElement<NFeDispatchResponseMethod> createNFeDispatchResponseMethod(
			final NFeDispatchResponseMethod receivable) {
		return new JAXBElement<>(new QName(ObjectFactory.NFE_AUT_LOTE_RESULT), NFeDispatchResponseMethod.class,
				receivable);
	}

	// @XmlElementDecl(name = ObjectFactory.NFE_RET_AUT_RESULT)
	// public JAXBElement<BatchReceiptSearchResponseMethod>
	// createBatchReceiptSearchResponseMethod(final BatchReceiptSearchResponseMethod
	// receivable) {
	// return new JAXBElement<>(new QName(ObjectFactory.NFE_RET_AUT_RESULT),
	// BatchReceiptSearchResponseMethod.class, receivable);
	// }

	// @XmlElementDecl(name = ObjectFactory.NFE_REC_EVENTO_RESULT)
	// public JAXBElement<EventDispatchResponseMethod>
	// createEventDispatchResponseMethod(final EventDispatchResponseMethod
	// receivable) {
	// return new JAXBElement<>(new QName(ObjectFactory.NFE_REC_EVENTO_RESULT),
	// EventDispatchResponseMethod.class, receivable);
	// }
	...
	@XmlElementDecl(name = ObjectFactory.MANIF_DEST_EVENTO_RESULT)
	public JAXBElement<RecipientManifestationResponseMethod> createRecipientManifestationResult(
			final RecipientManifestationResponseMethod transmissible) {
		return new JAXBElement<>(new QName(ObjectFactory.MANIF_DEST_EVENTO_RESULT),
				RecipientManifestationResponseMethod.class, transmissible);
	}
