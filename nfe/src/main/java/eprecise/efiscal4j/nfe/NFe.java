...
import eprecise.efiscal4j.nfe.contingency.NFeContingency;
...
public class NFe extends FiscalDocument {
    ...
    /**
     * @see NFeContingency
     * @param nFeContingency
     */
    private final NFeContingency nFeContingency;
    ...
    public NFe(
            ...
            final IODate entranceOrExit,
            final NFeFinality finality,
            final FiscalDocumentType type,
            final Boolean endConsumer,
            ...
            final NFeContingency nFeContingency
    ) {
        super(
                ...
                serie,
                number,
                Optional.ofNullable(emission).orElse(new CurrentEmissionDate()),
                emitter,
                items,
                charging,
                payment,
        ...
        this.export = export;
        this.nFeContingency = nFeContingency;
    }
