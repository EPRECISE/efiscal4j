...
public class AdditionalInfo implements Serializable {
	...
	public static class Builder {
		 ...
		 * @return
		 */
		public Builder withAdditionalInfoFisco(String additionalInfoFisco) {
		 ...
		 * @return
		 */
		public Builder withComplementaryInfo(String complementaryInfo) {
		 ...
		 * @return
		 */
		public Builder withTaxpayerObservations(List<CustomizedObservation> taxpayerObservations) {
		 ...
		 * @return
		 */
		public Builder withFiscoObservations(List<CustomizedObservation> fiscoObservations) {
		 ...
		 * @return
		 */
		public Builder withReferencedProcesses(List<ReferencedProcess> referencedProcesses) {
			this.referencedProcesses = referencedProcesses;
			return this;
		}

		public AdditionalInfo build() {
			AdditionalInfo entity = new AdditionalInfo(this);
