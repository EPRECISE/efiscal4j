...
public enum NFeTransmissionProcess {
	...
	@XmlEnumValue("2") AVULSA_CONTRIBUINTE_CERTIFICADO_DIGITAL_SITE_FISCO(2, "Emissão de NF-e avulsa, pelo contribuinte com seu certificado digital, através do site do Fisco"),	
