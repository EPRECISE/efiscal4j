...
public class ICMSTotal {
	...
	private @XmlElement(name = "vBC") @NotNull @Pattern(regexp = "0|0\\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?") final String icmsCalculationBasis;

	private @XmlElement(name = "vICMS") @NotNull @Pattern(regexp = "0|0\\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?") final String icmsTotalValue;

	private @XmlElement(name = "vICMSDeson") @NotNull @Pattern(regexp = "0|0\\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?") final String icmsTotalDesoneration;

	private @XmlElement(name = "vBCST") @NotNull @Pattern(regexp = "0|0\\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?") final String icmsSTCalculationBasis;

	private @XmlElement(name = "vST") @NotNull @Pattern(regexp = "0|0\\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?") final String icmsSTTotalValue;

	private @XmlElement(name = "vProd") @NotNull @Pattern(regexp = "0|0\\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?") final String itemsTotalValue;

	private @XmlElement(name = "vFrete") @NotNull @Pattern(regexp = "0|0\\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?") final String shippingTotalValue;

	private @XmlElement(name = "vSeg") @NotNull @Pattern(regexp = "0|0\\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?") final String insuranceTotalValue;

	private @XmlElement(name = "vDesc") @NotNull @Pattern(regexp = "0|0\\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?") final String discountTotalValue;

	private @XmlElement(name = "vII") @NotNull @Pattern(regexp = "0|0\\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?") final String iiTotalValue;

	private @XmlElement(name = "vIPI") @NotNull @Pattern(regexp = "0|0\\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?") final String ipiTotalValue;

	private @XmlElement(name = "vPIS") @NotNull @Pattern(regexp = "0|0\\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?") final String pisTotalValue;

	private @XmlElement(name = "vCOFINS") @NotNull @Pattern(regexp = "0|0\\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?") final String cofinsTotalValue;

	private @XmlElement(name = "vOutro") @NotNull @Pattern(regexp = "0|0\\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?") final String otherIncidentalCostsTotalValue;

	private @XmlElement(name = "vNF") @NotNull @Pattern(regexp = "0|0\\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?") final String nfeTotalValue;

	private @XmlElement(name = "vTotTrib") @Pattern(regexp = "0|0\\.[0-9]{2}|[1-9]{1}[0-9]{0,12}(\\.[0-9]{2})?") String taxTotalValue;
