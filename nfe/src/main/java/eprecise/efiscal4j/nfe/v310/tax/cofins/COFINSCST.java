...
public enum COFINSCST implements Serializable {
    ...
    private final PropertiesLoader cofinsCstMap = new PropertiesLoader.Builder().resourceLoader(COFINSCST.class).from("/eprecise/efiscal4j/nfe/v310/cofinsCst.properties").create();
