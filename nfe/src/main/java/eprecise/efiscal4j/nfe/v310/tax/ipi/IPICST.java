...
public enum IPICST implements Serializable {
    ...
    private final PropertiesLoader ipiCstMap = new PropertiesLoader.Builder().resourceLoader(IPICST.class).from("/eprecise/efiscal4j/nfe/v310/ipiCst.properties").create();
