...
public class EventDispatchCancellationTest implements Testable {
    ...
    private final NFeDomain nFeDomain = new NFeDomain(EventDispatch.XSD_CANC);

    @Test
    public void validateByBeanValidation() throws Exception {
        try {
            ValidationBuilder.from(this.getTestDomain().buildEventDispatchCancellation()).validate().throwIfViolate();
    ...
    public void validateByXSD() throws Exception {
        final String xml = new FiscalDocumentSerializer<>(this.getTestDomain().buildEventDispatchCancellation()).serialize();
