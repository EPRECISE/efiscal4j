...
public class BatchReceiptSearchResponseTest implements Testable {
    ...
    public void validateByBeanValidation() throws Exception {
        try {
            ValidationBuilder.from(this.getTestDomain().buildBatchReceiptSearchResponse()).validate().throwIfViolate();
    ...
    public void validateByXSD() throws Exception {
        final String xml = new FiscalDocumentSerializer<>(this.getTestDomain().buildBatchReceiptSearchResponse()).serialize();
