...
public class ProcessedNFeTest implements Testable {
    ...
    public void validateByBeanValidation() throws Exception {
        try {
            ValidationBuilder.from(this.getTestDomain().buildProcessedNFe()).validate().throwIfViolate();
    ...
    public void validateByXSD() throws Exception {
        final String xml = new FiscalDocumentSerializer<ProcessedNFe>(this.getTestDomain().buildProcessedNFe()).serialize();
