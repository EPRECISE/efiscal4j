...
public class NFeGenerationTest {
    ...
    public void validateByXSD() throws JAXBException, SAXException, IOException {
        final FiscalDocumentValidator validator = new FiscalDocumentValidator(this.getClass().getResource("/eprecise/efiscal4j/nfe/nfe_v3.10.xsd"));
        NFe nFe = null;
        try {
            nFe = this.buildNFe();
        } catch (final Exception e) {
        ...
        final String serialize = new FiscalDocumentSerializer<>(nFe).considering(NFe.class, LegalEntityDocuments.class, NaturalPersonDocuments.class).serialize();
