 ...
 * 
 */
public class NFeSimpleTransmitEventCancellationTest {
    ...
    public void transmitNFeStatusSearch() throws Exception {
        ...
        final TransmissionResult transmissionResult = transmissionChannel.transmitEventReceptionCancellation(this.buildEventDispatchCancellation(keyCertificate), FiscalDocumentModel.NFE);
    ...
    public EventDispatch buildEventDispatchCancellation(final Certificate keyCertificate) throws Exception {
      //@formatter:off
                ...
                .withEvents(Arrays.asList(new Event.Builder()
                        .withEventInfo(new EventInfo.Builder()
                                ...
                                .withEventDetail(new EventDetailCancellation.Builder()
                                        .withProtocolNumber("141180000352483")
                                        .withJustification("Teste de cancelamento")
                                        .build())
                                .build())
                        .build(signer)))
                .build();
