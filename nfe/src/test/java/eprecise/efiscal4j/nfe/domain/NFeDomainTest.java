...
public class NFeDomainTest {
    ...
    public NFe.NFeBuilder getDefaultNFeBuilder() {
        return NFe.builder()
                ...
                .transmissionMethod(NFeTransmissionMethod.NORMAL)
                .serie(this.buildSerie())
                .number(NFeDomainTest.number)
                .transport(
                        Transport.builder()
                                .shippingModality(ShippingModality.WITHOUT_TRANSPORT)
                                .build()
                )
    ...
    private Collection<ItemTax> buildItemTaxes() {
        final ICMS icms = ICMSSN103.builder()
                .origin(ProductOrigin.NATIONAL)
                .build();
        final PIS pis = PIS07.builder()
                .build();
        final COFINS cofins = COFINS07.builder()
                .build();
        return Stream.of(icms, pis, cofins)
    ...
    private EmitterDocuments buildEmitterDocuments() {
        return EmitterLegalEntityDocuments.builder()
                ...
                .ie(
                        NFeTestParams.getEmitterIe()
                                .orElse("000000")
                )
                .cnpj(
                        NFeTestParams.getEmitterCnpj()
                                .orElse("14241297000191")
                )
    ...
    private eprecise.efiscal4j.nfe.technicalManager.TechnicalManager buildTechnicalManager() {
        return eprecise.efiscal4j.nfe.technicalManager.TechnicalManager.builder()
                .contactName("Fernando")
                .cnpj("14241297000191")
                .email("contato@e-precise.com.br")
                .phone("1146376515")
                .build();
    }
